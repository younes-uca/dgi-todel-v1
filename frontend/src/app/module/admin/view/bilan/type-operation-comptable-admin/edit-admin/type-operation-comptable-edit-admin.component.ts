...
@Component({
  selector: 'app-type-operation-comptable-edit-admin',
  templateUrl: './type-operation-comptable-edit-admin.component.html'
})
export class TypeOperationComptableEditAdminComponent extends AbstractEditController<TypeOperationComptableDto, TypeOperationComptableCriteria, TypeOperationComptableService>   implements OnInit {
