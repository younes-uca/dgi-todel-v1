...
@Component({
  selector: 'app-etat-bilan-create-admin',
  templateUrl: './etat-bilan-create-admin.component.html'
})
export class EtatBilanCreateAdminComponent extends AbstractCreateController<EtatBilanDto, EtatBilanCriteria, EtatBilanService>  implements OnInit {
