package ma.sir.dgi.zynerator.converter;


import ma.sir.dgi.zynerator.bean.Etablissement;
import ma.sir.dgi.zynerator.dto.EtablissementDto;

import ma.sir.dgi.zynerator.util.ListUtil;
import ma.sir.dgi.zynerator.audit.AuditBusinessObject;
import ma.sir.dgi.zynerator.bean.BusinessObject;
import ma.sir.dgi.zynerator.dto.AuditBaseDto;
import ma.sir.dgi.zynerator.dto.BaseDto;
import ma.sir.dgi.zynerator.util.DateUtil;
import ma.sir.dgi.zynerator.util.RefelexivityUtil;
import ma.sir.dgi.zynerator.util.StringUtil;
import ma.sir.dgi.zynerator.util.Utils;
