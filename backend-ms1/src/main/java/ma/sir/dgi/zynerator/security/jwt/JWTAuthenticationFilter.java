package ma.sir.dgi.zynerator.security.jwt;
...
import ma.sir.dgi.DgiApplication;
import ma.sir.dgi.zynerator.security.common.SecurityParams;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        UserService userService = DgiApplication.getCtx().getBean(UserService.class);
