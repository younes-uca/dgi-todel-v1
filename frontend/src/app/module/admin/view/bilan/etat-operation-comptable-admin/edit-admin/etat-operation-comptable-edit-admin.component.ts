...
@Component({
  selector: 'app-etat-operation-comptable-edit-admin',
  templateUrl: './etat-operation-comptable-edit-admin.component.html'
})
export class EtatOperationComptableEditAdminComponent extends AbstractEditController<EtatOperationComptableDto, EtatOperationComptableCriteria, EtatOperationComptableService>   implements OnInit {
